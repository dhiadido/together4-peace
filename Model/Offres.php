...
class Offre {
    ...
    public function __construct($nomSpecialiste = null, $description = null, $prix = null, 
                                ...
                                $image = '../../assets/images/logo.png', $article_id = null) { // CHANGED
        ...
        $this->image = $image;
        $this->article_id = $article_id; // CHANGED
    }
    ...
    public function getArticleId() { // CHANGED
    ...
    public function setArticleId($article_id) { // CHANGED
